export const CELearningProcessMonitoringXML = {
    msgTitle: '认知评价-学习过程监控',
    msgList: [
        {
            step: '1',
            promptTitle: '学习状态感知',
        ...
        },
        {
            ...
            promptTitle: '学习计划回顾',
            promptContent:
                '请查看“学习管理”工具中的目标与待办事项分析，分析一下你所制定的学习任务有哪些，与当前的学习进度情况的关系是如何的',
            answer: ''
        },
        {
            step: '3',
            promptTitle: '评价与策略调节',
            promptContent:
                '现在请你在状态感知以及学习目标的基础上，仔细分析你产生这种反应、情绪、感受的原因是什么，是因为知识难度过大，还是因为自己没有仔细阅读，还是其他原因。请你做仔细的评价，并分析可能的解决方案是什么。请在反思日志中写下你的更详细的看法。',
            answer: ''
        }
    ]
};
