    ...
    return (
        <Paper variant="outlined" sx={{ mt: 2, p: '20px 30px', '& *': { lineHeight: '27px' } }}>
            ...
            <Typography variant="body1">
                ...
                status’ of context in complexity theory in connecting what happens in here and now
                with change in the system and with the emergence of ‘global order’ in the system
                over time）。其中，总体秩序（global
