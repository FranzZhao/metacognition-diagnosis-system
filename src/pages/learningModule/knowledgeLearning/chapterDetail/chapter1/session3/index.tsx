...
const Chapter1Session3 = () => {
    return (
        <Paper variant="outlined" sx={{ mt: 2, p: '20px 30px', '& *': { lineHeight: '27px' } }}>
            ...
            <Typography variant="body1">④ 能量的可用性（以克服熵增或无序的自然趋势）</Typography>
            <Typography variant="h6" fontWeight="bold" margin="10px 0">
                1.2 科学研究中的自组织现象
            </Typography>
            <Typography variant="body1">
            ...
            <Typography variant="body1">
                ...
                中阐述了市场自组织在商业周期中的作用。弗里德里希·哈耶克 Friedrich Hayek 创造了术语“
                耦合秩序 catallaxy” ，以描述一种“自愿合作的自组织系统 Self-organizing system of
                voluntary
            ...
            <Typography variant="body1">
                ...
                Negative feedback control loop。它可以作为学习谈话或对话在学习者之间或一个人进行。
            </Typography>
